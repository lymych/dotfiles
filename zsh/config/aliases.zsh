...
alias gf='git fetch'
alias gl='git log --graph --branches --remotes --tags --date=iso8601 --pretty=log-default'
alias gld='git log --graph --branches --remotes --tags --date=iso8601 --pretty=log-full'
alias gr='git reflog --date=iso8601 --pretty=reflog-default'
alias grd='git reflog --date=iso8601 --pretty=reflog-full'
